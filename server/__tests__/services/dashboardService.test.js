...
describe('Dashboard Service - org_id Scoping', () => {
    ...
    it('should scope all queries to the provided account_id', async () => {
        ...
        mockSupabase.from.mockImplementation((table) => {
            switch (table) {
                ...
                case 'payments':
                    return mockPaymentsChain;
                case 'maintenance_requests':
                    return mockMaintenanceChain;
                case 'tenants':
        ...
        await (0, dashboardService_1.getDashboardSummary)(mockAccountId);
    ...
    it('should not allow cross-account data access', async () => {
        ...
        const resultA = await (0, dashboardService_1.getDashboardSummary)(accountA);
    ...
    it('should handle account_id parameter correctly in all subqueries', async () => {
        ...
        const accountIdCalls = mockChain.eq.mock.calls.filter((call) => call[0] === 'account_id' && call[1] === mockAccountId);
