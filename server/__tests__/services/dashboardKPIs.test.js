...
describe('Dashboard KPI Calculations', () => {
    ...
    describe('Total Units and Occupancy', () => {
        it('should calculate total units correctly', async () => {
            ...
            const result = await (0, dashboardService_1.getDashboardSummary)(mockAccountId);
    ...
    describe('System Metrics', () => {
        ...
        it('should set support availability based on plan', async () => {
            ...
            const premiumResult = await (0, dashboardService_1.getDashboardSummary)(mockAccountId);
            ...
            const basicResult = await (0, dashboardService_1.getDashboardSummary)(mockAccountId);
